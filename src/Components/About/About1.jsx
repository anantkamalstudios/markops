...
const FeatureList = [
  {
    ...
    description:
      "Daily selections of top-quality ads and trending new ads to inspire your visual design and copywriting creativity.",
  },
  {
    title: "Niche Search",
    description:
      "Discover potential niche markets and ideas through social validation and the latest data, helping you stay ahead of market trends.",
  },
  {
    title: "Ad Tracking",
    description:
      "Easily track top-performing ads, save time and costs, optimize ad cost, and maximize profits.",
  },
  {
    title: "User Acquisition",
    description:
      "Accurately analyze user preferences by country, time, and gender to help you acquire target users more effectively.",
  },
];
