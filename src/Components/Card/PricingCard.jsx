...
const PricingCard = ({
  ...
  const visibleFeatures = isExpanded ? FeatureList : FeatureList?.slice(0, 5);

  return (
    <div className="col-xl-4 col-md-6">
      <div
        className="pricing-card style1 shadow-none h-100 d-flex flex-column"
        style={
          popular ? { border: "2px solid #6B4DFB", position: "relative" } : {}
        }
      >
        {popular && (
          <div
          ...
          {FeatureList?.length > 5 && (
            <div className="text-center mt-3">
              <button
                ...
                className="btn-link text-primary border-0 bg-transparent p-0"
                style={{
                  fontSize: "14px",
                  fontWeight: "500",
        ...
        <Link className="theme-btn style5 mt-auto" to={btnurl}>
          {" "}
          {btnname}{" "}
        </Link>
      </div>
