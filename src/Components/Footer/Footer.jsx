            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  <p>
                    Unlock the full potential of your campaigns with our
                    data-driven marketing app. From lead generation to
                    conversion tracking, our tool helps you scale faster, reach
                    the right audience, and boost ROI — all in one platform.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="single-footer-widget">
                ...
                <ul className="list-area">
                  ...
                  <li>
                    <Link to="/google-page">Google</Link>
                  </li>
                  <li>
