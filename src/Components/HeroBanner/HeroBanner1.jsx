        ...
        <div className="intro-container-wrapper style1">
          <div className="container">
            <div className="intro-wrapper style1 fix">
              ...
              <div className="container">
                <div className="row">
                  <div className="col-lg-5 col-xl-6 order-2 order-lg-1 mt-5 mt-lg-0">
                  ...
                  <div className="col-lg-7 col-xl-6 order-1 order-lg-2 text-center text-lg-end mb-4 mb-lg-0 d-none d-lg-block">
